...
package body GNAT.Formatted_String is
   ...
   type F_Sign is (If_Neg, Forced, Space);

   type F_Base is (None, C_Style, Ada_Style);
   ...
   procedure Raise_Wrong_Format (Format : Formatted_String);
   pragma No_Return (Raise_Wrong_Format);
